...
--
-- Definition of table `tbl_artenatif`
--

DROP TABLE IF EXISTS `tbl_artenatif`;
CREATE TABLE `tbl_artenatif` (
...
--
-- Dumping data for table `tbl_artenatif`
--

/*!40000 ALTER TABLE `tbl_artenatif` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_artenatif` ENABLE KEYS */;
